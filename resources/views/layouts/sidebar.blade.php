        ...
        <ul class="list-none list-inside px-5 mb-3">
            ...
            <li>
                <a href="{{ route('borrow.index') }}"
                    class="transition-all ease-in-out duration-300 flex items-center p-3 rounded-lg mb-1 {{ Request::is('borrow*') ? 'shadow-lg shadow-blue-200 rounded-lg bg-gradient-to-br from-blue-400 to-blue-500' : '' }}">
